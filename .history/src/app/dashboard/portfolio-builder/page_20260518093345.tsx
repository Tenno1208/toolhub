...
import { 
  ...
  User, Instagram, Twitter, GitHub, Music2, Mail, Globe, Link2 
} from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5 space-y-6 bg-slate-900/40 border border-white/5 p-6 rounded-3xl backdrop-blur-md overflow-y-auto max-h-[85vh]">
            ...
            <div className="pt-4 border-t border-white/5">
              ...
              {/* TikTok Input */}
              <div className="relative group">
                <Music2 className="absolute left-4 top-3.5 w-4 h-4 text-slate-600 group-focus-within:text-cyan-400 transition-colors" />
