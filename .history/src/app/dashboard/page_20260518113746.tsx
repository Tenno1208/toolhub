...
import { 
  ...
  CloudSun, DollarSign, PenTool, ScanText
} from 'lucide-react';
...
// Data Database Tools Lengkap (Total Berjumlah 32 Tools Sesuai Deskripsi Header)
const tools = [
  ...
  { id: 21, name: 'Git Generator', icon: <GitBranch className="w-7 h-7" />, path: '/git-generator', category: 'Developer & Security' },
  { id: 22, name: 'Regex Tester', icon: <Binary className="w-7 h-7" />, path: '/regex-tester', category: 'Developer & Security' },
    ...
    <div className="min-h-screen bg-slate-950 pt-24 pb-0 flex flex-col justify-between select-none">
      ...
      <div className="w-full px-4 sm:px-8 mb-16">
        ...
        <section className="max-w-6xl mx-auto flex flex-col items-center sm:items-start text-center sm:text-left mb-14 w-full">
          ...
          {/* Subtitle / Deskripsi List Atas (🚀 UPDATED TO 32 TOOLS) */}
          <p className="text-xs sm:text-sm font-mono text-slate-500 mb-2 uppercase tracking-widest">
            Portfolio Generator | TikTok Downloader | 32 Tools | AI Assistant
          </p>
