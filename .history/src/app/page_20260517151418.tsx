...
<header className="max-w-6xl mx-auto flex flex-col items-center mb-16">
  <div className="flex items-center gap-4 mb-6">
    ...
    {/* Menggunakan custom logo kamu */}
    <div className="w-16 h-16 relative rounded-2xl overflow-hidden shadow-lg shadow-purple-500/20">
      <Image 
        src="/logo.png" // Sesuaikan dengan nama file logomu di folder public
        alt="ToolHub Logo"
        fill
